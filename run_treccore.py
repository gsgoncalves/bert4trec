"""Code to train and eval a BERT passage re-ranker on the WaPo and WSJ datasets."""
...
flags.DEFINE_string(
    "bert_config_file",
    "/nas/Datasets/text_embedings/bert/pretrained_models/uncased_L-12_H-768_A-12/bert_config.json",
...
flags.DEFINE_string(
    "init_checkpoint",
    "/nas/Datasets/text_embedings/bert/pretrained_models/uncased_L-12_H-768_A-12/bert_model.ckpt.data-00000-of-00001",
...
METRICS_MAP = ['map', 'P_5', 'P_10', 'P_30', 'P_50', 'P_100', 'P_1000', 'Rprec', 'ndcg_cut_5', 'ndcg_cut_10',
               'ndcg_cut_30', 'ndcg_cut_100', 'ndcg_cut_1000']
