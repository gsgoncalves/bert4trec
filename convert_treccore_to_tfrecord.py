"""Converts TREC-CORE queries and corpus into TFRecord that will be consumed by BERT.
...
flags.DEFINE_string(
    "vocab_file",
    "/nas/Datasets/text_embeddings/bert/uncased_L-12_H-768_A-12/vocab.txt",
    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
    "corpus", "../WashingtonPost.v2/data/wapo_body_clean.jsonl",
    "Path to the corpus in json format.")
...
def load_corpus(path):
  """Loads TREC-CORE's docs from a json into a dict of key: docid, value: body."""
  corpus = {}
